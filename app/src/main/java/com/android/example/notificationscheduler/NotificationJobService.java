...
public class NotificationJobService extends JobService {
    ...
    @Override public boolean onStartJob(JobParameters jobParameters) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, PRIMARY_CHANNEL_ID)
                ...
                .setContentTitle(getString(R.string.job_service)).setContentText(getString(R.string.job_running))
                .setContentIntent(contentPendingIntent).setSmallIcon(R.drawable.ic_job_running)
